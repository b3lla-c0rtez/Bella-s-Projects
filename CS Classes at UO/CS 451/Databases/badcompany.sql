CREATE DATABASE  IF NOT EXISTS `badcompany` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `badcompany`;
...
INSERT INTO `department` VALUES ('Headquarters',1,888665555,'1971-06-19'),('Administration',4,987654321,'1985-01-01'),('Research',5,333445555,'1978-05-22'),('HR',7,333445555,NULL);
...
INSERT INTO `project` VALUES ('ProductX',1,'Bellaire',5),('ProductY',2,'Sugarland',5),('ProductZ',3,'Houston',5),('Crabbing',4,'Coos Bay',5),('Computerization',10,'Stafford',4),('Reorganization',20,'Houston',1),('Newbenefits',30,'Stafford',4);
...
-- Dump completed on 2015-10-24 20:57:45
