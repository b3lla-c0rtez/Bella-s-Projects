...
class Test_Extract_Insert(unittest.TestCase):

    def test_extract(self):
        bits = BitField(4,8)
        self.assertEqual(bits.extract(0b111111111101111110101), 0b11111)

    def test_inset(self):
        bits = BitField(4,7)
        self.assertEqual(bits.insert(0b1010, 0b000001111), 0b10101111)
